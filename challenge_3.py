...
must stop and salute each other -- one at a time -- before resuming their
...
walking along a hallway and returns the number of times the employees will
salute. s will contain at least 1 and at most 100 characters, each one of -,
>, or <.
"""
...
def solution(s: str) -> int:
    ...
    Args:
        s: A string representing the layout of the hallway. It contains at
