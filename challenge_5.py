...
creation efficiency by predicting the end state of a given ore sample. You
have carefully studied the different structures that the ore can take and
which transitions it undergoes. It appears that, while random, the
...
return an array of ints for each terminal state giving the exact
...
# (yes, this is a verbose solution) by using a module like Numpy or Scipy and Fractions.
